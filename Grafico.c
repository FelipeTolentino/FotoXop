...
void gerenciaTeclado(unsigned char key, int mx, int my) {
    ...
    case '6':
        ...
        copiaDaImagem = copiaImagem(imagem);
        desfocarImagem(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao desfocarImagem.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: Destacar relevo */
    case '7':
        AVISO(Grafico: aplicando o destaque de relevo na imagem.);
        copiaDaImagem = copiaImagem(imagem);
        destacarRelevo(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao destacarRelevo.\n);
        opcoes();
        desenha();
        break;
   /* Filtro: Troca de cores */
    case '8':
        AVISO(Grafico: trocando a cor da imagem.);
        copiaDaImagem = copiaImagem(imagem);
        trocaCor(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao trocaCor.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: Espelhar */
    case '9':
        AVISO(Grafico: espelhando imagem.);
        copiaDaImagem = copiaImagem(imagem);
        espelhar(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao espelhar.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: Negativo */
    ...
    case 'N':
        ...
        copiaDaImagem = copiaImagem(imagem);
        negativarImagem(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao negativarImagem.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: Glitch */
    case 'g':
    case 'G':
        AVISO(Grafico: aplicando o filtro glitch na imagem.);
        copiaDaImagem = copiaImagem(imagem);
        filtroGlitch(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao filtroGlitch.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: Listras */
    case 'l':
    case 'L':
        AVISO(Grafico: aplicando o filtro listras na imagem.);
        copiaDaImagem = copiaImagem(imagem);
        filtroListras(imagem);
        imagemFoiModificada = true;
        AVISO(Grafico: voltei da funcao filtroListras.\n);
        opcoes();
        desenha();
        break;
    /* Filtro: meuFiltro */
...
void opcoes() {
    printf("Escolha uma opção:\n"
           ...
           " 'g' para aplicar o efeito glitch\n"
           " 'l' para aplicar listras a imagem\n"
           " 'n' para aplicar o negativo\n"
